...
# Run lead prospector (auto-rotation)
.\pipeline\Run-Prospector.ps1
# Or directly:
cd pipeline && python prospector.py

# Prospector: manual search
python pipeline/prospector.py --suburb Sandton --industry plumber

# Prospector: burst mode (3 searches)
.\pipeline\Run-Prospector.ps1 -Burst 3

# Prospector: stats / rotation preview
